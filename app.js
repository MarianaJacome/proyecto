    ...
    e.exports = function() {
        ...
        function k(e, t) {
            for (var r = new Array(e.length), n = 0; n < e.length; n++)
                "object" == typeof e[n] && (r[n] = new RegExp("^(?:" + e[n].pattern + ")$",S(t)));
            return function(t, n) {
        ...
        function O(e, t, r) {
            for (var n = (r = r || {}).strict, o = !1 !== r.start, i = !1 !== r.end, s = r.delimiter || y, a = [].concat(r.endsWith || []).map(E).concat("$").join("|"), u = o ? "^" : "", c = 0; c < e.length; c++) {
                ...
                if ("string" == typeof h)
                    ...
                    t && t.push(h),
                    u += h.optional ? h.prefix ? "(?:" + E(h.prefix) + "(" + f + "))?" : "(" + f + ")?" : E(h.prefix) + "(" + f + ")"
                }
            }
            if (i)
                n || (u += "(?:" + E(s) + ")?"),
        ...
        var R = {
                ...
                var r = function() {
                    if (!t.next.html)
                        return Promise.resolve(e).then((function(e) {
                            ...
                            if (e) {
                                var n = T.toElement(e);
                                r.namespace = T.getNamespace(n),
                                r.container = T.getContainer(n),
                                r.html = e,
                                L.update({
                                    ns: r.namespace
                                });
          ...
          , N = function(e) {
            ...
            var o, i = e.replace(H(), ""), s = {}, a = i.indexOf("#");
            a >= 0 && (o = i.slice(a + 1),
            i = i.slice(0, a));
            var u = i.indexOf("?");
          ...
          , oe = function(e) {
            function t(r, n) {
                ...
                for (var i = arguments.length, s = new Array(i > 2 ? i - 2 : 0), a = 2; a < i; a++)
                    s[a - 2] = arguments[a];
                return (o = e.call.apply(e, [this].concat(s)) || this).error = r,
                o.label = n,
        ...
        return new (function() {
            ...
            n.init = function(e) {
                var t = void 0 === e ? {} : e
                  ...
                  , P = t.debug
                  , x = t.logLevel;
                if (p.setLevel(!0 === (void 0 !== P && P) ? "debug" : void 0 === x ? "off" : x),
                ...
                if (this.cache = new K(v),
                this.prevent = new ne(m),
                this.transitions = new se(o),
                this.views = new ae(s),
                null !== w) {
                    ...
                    var s = i.cache.has(e) ? i.cache.update(e, {
                      ...
                      , a = function() {
                        if (i.transitions.shouldWait)
                            return Promise.resolve(q(s, i.data)).then((function() {}
                            ))
                    }();
    ...
    new (function() {
        ...
        t.next = function(e, t) {
            try {
                var r = this;
                return r.t = r.g(e),
                Promise.resolve(r.t ? new Promise((function(n) {
                    try {
                        return r.cb = n,
                        r.callbacks[t] = n,
